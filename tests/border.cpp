...
class border_test_class
{
    public:
        void constructor_and_methods(Border &border)
        {
        ...
        void get_sources_point(Border &border)
        {
            vector<Point> p;
...
{   
    border_test_class a;
    Border border;
    a.constructor_and_methods(border);
}
