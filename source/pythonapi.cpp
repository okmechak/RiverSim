...
BOOST_PYTHON_MODULE(riversim)
{
    ...
    class_<BranchNew, bases<t_PointList>>("Branch", "Holds all functionality that you need to work with single branch.")
        ...
        .def("tipVector", &BranchNew::TipVector, "Returns vector of tip - difference between two adjacent points.")
        .def("vector", &BranchNew::Vector, "Returns vector of p i-th segment of branch.")
        .def("tipAngle", &BranchNew::TipAngle, "Returns angle of branch tip.")
        .def("sourcePoint", &BranchNew::SourcePoint, "Returns source point of branch(the first one).")
        .def("sourceAngle", &BranchNew::SourceAngle, "Returns source angle of branch.")
        .def("lenght", &BranchNew::Lenght, "Returns lenght of whole branch.")
        .def(self == self)
    ;
