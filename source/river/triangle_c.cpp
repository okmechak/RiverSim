...
{
  return (int)ac_global->refinementFunction(
    River::Point{(double)triorg[0], (double)triorg[1]}, 
    River::Point{(double)tridest[0], (double)tridest[1]},
    River::Point{(double)triapex[0], (double)triapex[1]},
    (double)area);
}
...

{
  ...
  if (printvertex == (vertex)NULL)
    ...
    printf("    Origin[%d] = x%lx  (%.12Lg, %.12Lg)\n",
...
void printsubseg(struct mesh *m, struct behavior *, struct osub *s)
{
  ...
  if (printvertex == (vertex)NULL)
    ...
    printf("    Segment origin[%d] = x%lx  (%.12Lg, %.12Lg)\n",
  ...
  if (printvertex == (vertex)NULL)
    ...
    printf("    Segment dest  [%d] = x%lx  (%.12Lg, %.12Lg)\n",
               ...
               int subsegbytes)
{
  ...
  m->dummytri = (triangle *)(alignptr + (INT_PTR)m->triangles.alignbytes -
  ...
  if (b->usesegments)
  {
    ...
    m->dummysub = (subseg *)(alignptr + (INT_PTR)m->subsegs.alignbytes -
...

{
  ...
  permanent = (Absolute(bdxcdy) + Absolute(cdxbdy)) * Absolute(adheight) + (Absolute(cdxady) + Absolute(adxcdy)) * Absolute(bdheight) + (Absolute(adxbdy) + Absolute(bdxady)) * Absolute(cdheight);
...

{
  ...
  if (b->verbose > 2)
  {
    ...
    printf("    (%.12Lg, %.12Lg) (%.12Lg, %.12Lg) (%.12Lg, %.12Lg)\n",
...

{
  ...
  if (encroached && (!b->nobisect || ((b->nobisect == 1) && (sides == 2))))
  {
    ...
    {
      printf(
          "  Queueing encroached subsegment (%.12Lg, %.12Lg) (%.12Lg, %.12Lg).\n",
                                ...
                                int stopatsubsegment)
{
  ...
  if (b->verbose > 2)
  {
    printf("  Searching for point (%.12Lg, %.12Lg).\n",
  ...
  while (1)
  {
    if (b->verbose > 2)
    {
      printf("    At (%.12Lg, %.12Lg) (%.12Lg, %.12Lg) (%.12Lg, %.12Lg)\n",
                         ...
                         vertex searchpoint, struct otri *searchtri)
{
  ...
  if (b->verbose > 2)
  {
    printf("  Randomly sampling for a triangle near point (%.12Lg, %.12Lg).\n",
           searchpoint[0], searchpoint[1]);
  }
  ...
  if (b->verbose > 2)
  {
    printf("    Boundary triangle has origin (%.12Lg, %.12Lg).\n",
           torg[0], torg[1]);
  }
  ...
  if (m->recenttri.tri != (triangle *)NULL)
  {
    if (!deadtri(m->recenttri.tri))
    {
      ...
      if (dist < searchdist)
      {
        ...
        if (b->verbose > 2)
        {
          printf("    Choosing recent triangle with origin (%.12Lg, %.12Lg).\n",
                 torg[0], torg[1]);
        }
      }
    }
    ...
    do
    {
      ...
      if (!deadtri(sampletri.tri))
      {
        ...
        if (dist < searchdist)
        {
          ...
          if (b->verbose > 2)
          {
            printf("    Choosing triangle with origin (%.12Lg, %.12Lg).\n",
                   torg[0], torg[1]);
          }
        }
      }
...

{
  ...
  if (b->verbose > 2)
  {
    printf("    Connecting edge to (%.12Lg, %.12Lg)\n", bestvertex[0],
           bestvertex[1]);
  }
  if (bestnumber > 1)
  {
...

{
  ...
  for (j = 1; j < m->invertices; j++)
  {
    if ((sortarray[i][0] == sortarray[j][0]) && (sortarray[i][1] == sortarray[j][1]))
    {
      ...
      {
        printf(
            "Warning:  A duplicate vertex at (%.12Lg, %.12Lg) appeared and was ignored.\n",
...

{
  ...
  while (leftflag)
  {
    ...
    if (searchtri->tri == m->dummytri)
    {
      ...
      printf("  triangle leading from (%.12Lg, %.12Lg) to", startvertex[0],
             startvertex[1]);
      printf("  (%.12Lg, %.12Lg).\n", searchpoint[0], searchpoint[1]);
      internalerror();
    }
...

{
  ...
  {
    printf(
        "  Splitting subsegment (%.12Lg, %.12Lg) (%.12Lg, %.12Lg) at (%.12Lg, %.12Lg).\n",
...

{
  ...
  if (b->verbose > 1)
  {
    printf("  Connecting (%.12Lg, %.12Lg) to (%.12Lg, %.12Lg).\n",
  ...
  if (checkvertex != endpoint1)
  {
    ...
    if (locate(m, b, endpoint1, &searchtri1) != ONVERTEX)
    {
      ...
      printf("  (%.12Lg, %.12Lg) in triangulation.\n",
...
void plague(struct mesh *m, struct behavior *b)
{
  ...
  while (virusloop != (triangle **)NULL)
  {
    ...
    if (b->verbose > 2)
    {
      ...
      printf("    Checking (%.12Lg, %.12Lg) (%.12Lg, %.12Lg) (%.12Lg, %.12Lg)\n",
      ...
      { /* The neighbor exists and is not infected. */
        if (neighborsubseg.ss == m->dummysub)
        {
          ...
          if (b->verbose > 2)
          {
            ...
            printf(
                "    Marking (%.12Lg, %.12Lg) (%.12Lg, %.12Lg) (%.12Lg, %.12Lg)\n",
                deadorg[0], deadorg[1], deaddest[0], deaddest[1],
                deadapex[0], deadapex[1]);
          }
          infect(neighbor);
    ...
    for (testtri.orient = 0; testtri.orient < 3; testtri.orient++)
    {
      ...
      if (testvertex != (vertex)NULL)
      {
        ...
        if (killorg)
        {
          if (b->verbose > 1)
          {
            printf("    Deleting vertex (%.12Lg, %.12Lg)\n",
    ...
    for (testtri.orient = 0; testtri.orient < 3; testtri.orient++)
    {
      ...
      if ((neighbor.tri != m->dummytri) && !infected(neighbor) && (neighborsubseg.ss == m->dummysub))
      {
        if (b->verbose > 2)
        {
          ...
          printf("    Marking (%.12Lg, %.12Lg) (%.12Lg, %.12Lg) (%.12Lg, %.12Lg)\n",
                 regionorg[0], regionorg[1], regiondest[0], regiondest[1],
                 regionapex[0], regionapex[1]);
        }
        /* Infect the neighbor. */
  ...
  while ((m->badsubsegs.items > 0) && (m->steinerleft != 0))
  {
    ...
    while ((encloop != (struct badsubseg *)NULL) && (m->steinerleft != 0))
    {
          ...
          (eorg == encloop->subsegorg) && (edest == encloop->subsegdest))
      {
        ...
        {
          printf("Error:  Ran out of precision at (%.12Lg, %.12Lg).\n",
                 newvertex[0], newvertex[1]);
                   ...
                   struct badtriang *badtri)
{
      ...
      (bdest == badtri->triangdest) && (bapex == badtri->triangapex))
  {
        ...
        ((newvertex[0] == bapex[0]) && (newvertex[1] == bapex[1])))
    {
      ...
      {
        printf(
            "Warning:  New vertex (%.12Lg, %.12Lg) falls on existing vertex.\n",
            newvertex[0], newvertex[1]);
        errorflag = 1;
      }
...
void quality_statistics(struct mesh *m, struct behavior *b)
{
  ...
  printf("  Smallest area: %16.5Lg   |  Largest area: %16.5Lg\n",
         smallestarea, biggestarea);
  printf("  Shortest edge: %16.5Lg   |  Longest edge: %16.5Lg\n",
         shortest, longest);
  printf("  Shortest altitude: %12.5Lg   |  Largest aspect ratio: %8.5Lf\n\n",
         minaltitude, worstaspect);

  printf("  Triangle aspect ratio histogram:\n");
  printf("  1.1547 - %-6.6Lg    :  %8d    | %6.6Lg - %-6.6Lg     :  %8d\n",
         ratiotable[0], aspecttable[0], ratiotable[7], ratiotable[8],
         aspecttable[8]);
  for (i = 1; i < 7; i++)
  {
    printf("  %6.6Lf - %-6.6Lf    :  %8d    | %6.6Lf - %-6.6Lf     :  %8d\n",
           ratiotable[i - 1], ratiotable[i], aspecttable[i],
           ratiotable[i + 7], ratiotable[i + 8], aspecttable[i + 8]);
  }
  printf("  %6.6Lf - %-6.6Lf    :  %8d    | %6.6Lf -            :  %8d\n",
         ratiotable[6], ratiotable[7], aspecttable[7], ratiotable[14],
         aspecttable[15]);
  printf("  (Aspect ratio is longest edge divided by shortest altitude)\n\n");

  printf("  Smallest angle: %15.5Lf   |  Largest angle: %15.5Lf\n\n",
