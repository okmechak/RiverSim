    ...
    class Triangle
    {
        ...
        public:
            ...
            */
             ...
             * Generate mesh.
             * 
             * @param boundary Boundary object which holds boundary constrains, and holes etc. 
             * @param holes Holds hols of region. 
             */
            tethex::Mesh generate_quadrangular_mesh(const Boundary &boundary, const t_PointList &holes);
